...
@Component({
  moduleId: module.id,
  selector: 'stc-status',
  templateUrl: './stc-status.component.html',
  styleUrls: ['./stc-status.component.scss']
})
export class PageStatusSTCComponent implements OnInit {
pageTitle: string = 'STC Status';
status: Status[]=[];
newstatus: Status[]=[];
