...
@Component({
  moduleId: module.id,
  selector: 'mobily-status',
  templateUrl: './mobily-status.component.html',
  styleUrls: ['./mobily-status.component.scss']
})
export class PageStatusMobilyComponent implements OnInit {
pageTitle: string = 'Mobily Status';
status: Status[]=[];
newstatus: Status[]=[];
