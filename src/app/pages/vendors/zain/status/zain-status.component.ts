...
@Component({
  moduleId: module.id,
  selector: 'zain-status',
  templateUrl: './zain-status.component.html',
  styleUrls: ['./zain-status.component.scss']
})
export class PageStatusZainComponent implements OnInit {
pageTitle: string = 'Zain Status';
status: Status[]=[];
newstatus: Status[]=[];
